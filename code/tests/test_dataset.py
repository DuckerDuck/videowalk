...
dataloader = SalientKinetics400(args.data_path, './saliency_cache_' + args.prior_dataset, args.frame_skip)

    
def test_same_as_file():
    frame = dataloader.load_frame(image)
    # torch.save(frame, reference)
